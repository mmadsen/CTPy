...
#
# mongodb aggregation query which returns mean richness for combinations of population size
# sample size, and mutation rate.
#
# db.richness_samples.aggregate(
#     { '$project' : {
#     'population_size' : 1,
#     'richness' : 1,
#     'mutation_rate' : 1,
...
#     {
#     '$group' : {
#     '_id': { population: '$population_size', mutation_rate : '$mutation_rate', samplesize: '$samplesize'},
...
def sampleEwensNumAlleles(pop, param):
    ...
    storeRichnessSample(popID,ssize,numAlleles,locus,gen,mutation,popsize)
...
simu.evolve(
	...
	postOps = [sim.KAlleleMutator(k=100000000, rates=pars.mutationrate),
        ...
        sim.PyOperator(func=sampleEwensNumAlleles, param=(pars.samplesize, pars.mutationrate, pars.popsize), step=pars.stepsize,begin=beginCollectingData),
...
# for mean in df.mean():
#     print(mean, end='\n')
#     record = {"mutationrate" : pars.mutationrate,
#               "samplesize" : pars.samplesize,
#               "mean_kn" : mean,
#               "numsamples" : n,
#               "population" : pars.popsize,
